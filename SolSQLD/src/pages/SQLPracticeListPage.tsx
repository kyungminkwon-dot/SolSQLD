...
// 목업 SQL 실습 문제
const SQL_PROBLEMS = [
  { id: 'sql1', title: 'EMP 테이블 전체 조회', category: 'DML', difficulty: 'easy' as Difficulty, correctRate: 92 },
  { id: 'sql2', title: 'GROUP BY와 HAVING 절', category: 'DML', difficulty: 'medium' as Difficulty, correctRate: 68 },
  { id: 'sql3', title: 'INNER JOIN 기본', category: 'JOIN', difficulty: 'medium' as Difficulty, correctRate: 74 },
  { id: 'sql4', title: 'LEFT OUTER JOIN', category: 'JOIN', difficulty: 'medium' as Difficulty, correctRate: 61 },
  { id: 'sql5', title: 'ROLLUP 함수 활용', category: '집합연산', difficulty: 'hard' as Difficulty, correctRate: 38 },
  { id: 'sql6', title: 'RANK / DENSE_RANK 윈도우 함수', category: '함수', difficulty: 'hard' as Difficulty, correctRate: 42 },
  { id: 'sql7', title: 'SUBSTR / INSTR 문자 함수', category: '함수', difficulty: 'easy' as Difficulty, correctRate: 81 },
  { id: 'sql8', title: '서브쿼리 기본', category: '서브쿼리', difficulty: 'medium' as Difficulty, correctRate: 55 },
  { id: 'sql9', title: 'EXISTS 서브쿼리', category: '서브쿼리', difficulty: 'hard' as Difficulty, correctRate: 33 },
  { id: 'sql10', title: 'INSERT / UPDATE / DELETE', category: 'DML', difficulty: 'easy' as Difficulty, correctRate: 88 },
]
...
export default function SQLPracticeListPage() {
  ...
  const filtered = useMemo(() => {
    ...
    if (sort === 'difficulty_asc') list = [...list].sort((a, b) => diffOrder[a.difficulty] - diffOrder[b.difficulty])
    if (sort === 'difficulty_desc') list = [...list].sort((a, b) => diffOrder[b.difficulty] - diffOrder[a.difficulty])
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      <div className="max-w-4xl mx-auto px-4 py-10">
        ...
        <p className="text-slate-500 text-sm mb-6">Oracle 환경에서 직접 SQL을 작성하고 결과를 확인하세요.</p>
          ...
          {filtered.map(problem => (
            ...
            >
              <div className="flex items-center gap-3">
                <span className={`text-xs px-2.5 py-1 rounded-full font-semibold ${DIFFICULTY_COLOR[problem.difficulty]}`}>
